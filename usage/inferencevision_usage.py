...
Original file is located at
    https://colab.research.google.com/drive/1Xrq8mK7j1n0UNdQkTE_O26kXMNQl_8Lj
...
# !pip install -r /content/requirements.txt -q  # You don't need to run this cell if you face with serious problem or problems. Use instead:
...
Invoke the `process_image` method to perform object detection and geographic coordinate calculation on the input image. Using GPU can speed up process.
"""
